...
Inventory existing docs, relevant implementation/configuration, tests, migrations, and available history. Map each documentation responsibility to its existing home before creating files. Resolve duplication with links and targeted consolidation; preserve useful content and record unresolved contradictions.
